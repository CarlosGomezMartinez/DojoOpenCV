...
Java_com_example_android_dojoopencv_MainActivity_FindFeatures(JNIEnv *jniEnv, jobject, jlong imGray,
                                                              jlong imRGB) {
...
JNIEXPORT void JNICALL
Java_com_example_android_dojoopencv_MainActivity_InitDetector(JNIEnv *jniEnv, jobject,
                                                              jstring jFilePath) {
...
JNIEXPORT void JNICALL
Java_com_example_android_dojoopencv_MainActivity_DetectFaces(JNIEnv *jniEnv, jobject, jlong imGray,
                                                             jlong imRGB) {
    Mat *mGray = (Mat *) imGray;
    Mat *mRGB = (Mat *) imRGB;
